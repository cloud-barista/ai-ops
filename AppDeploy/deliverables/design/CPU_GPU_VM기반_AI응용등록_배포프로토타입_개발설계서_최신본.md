...
| 실제 외부 API 호출 | 제외 | `deliverables/interface/external/외부_연동_경계_정리.md` |

최종 제출 전에는 `.\scripts\collect-evidence.ps1 -Port 18083`을 다시 실행하여 기준선 증적을 갱신하고, `deliverables/release/1차년도_제출_패키지_체크리스트.md` 기준으로 문서·API·시험 결과를 점검한다.
