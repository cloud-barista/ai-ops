...
```text
examples/interface/requests/app-create-cpu.json
examples/interface/requests/app-create-gpu.json
examples/interface/requests/app-create-invalid-container.json
examples/interface/requests/runtime-profile-gpu-vm.json
examples/interface/requests/target-profile-aws-gpu.json
examples/interface/requests/resource-check-gpu.json
examples/interface/requests/deployment-create-gpu.json
examples/interface/requests/deployment-stop.json

examples/interface/responses/app-create-success.json
examples/interface/responses/deployment-create-success.json
examples/interface/responses/deployment-status-running.json
examples/interface/responses/deployment-logs-success.json
examples/interface/responses/error-app-spec-invalid.json
examples/interface/responses/error-gpu-runtime-not-found.json
