...
const (
	...
	ReasonRequirementsSatisfied          = "REQUIREMENTS_SATISFIED"
	ReasonResourceRecommendationValid    = "RESOURCE_RECOMMENDATION_VALID"
	ReasonResourceRecommendationInvalid  = "RESOURCE_RECOMMENDATION_INVALID"
	ReasonApplicationRequirementsInvalid = "APPLICATION_REQUIREMENTS_INVALID"
...
type AutomationDecision struct {
	...
	RequiresManifestGeneration bool               `json:"requires_manifest_generation"`
...
type Flow struct {
	...
	RepairDecision         *AutomationDecision              `json:"repair_decision,omitempty"`
	UpdatedAt              string                           `json:"updated_at"`
}
