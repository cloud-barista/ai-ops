...
| Local API integration validation | `bash scripts/run_local_api_integration_validation.sh runs/local-api-integration-validation-YYYYMMDD-HHMMSS` | 6개 endpoint 순차 호출과 핵심 response field 검증 |
...
runs/
  ...
  local-api-integration-validation-YYYYMMDD-HHMMSS/
