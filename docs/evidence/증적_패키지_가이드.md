...
대표 로컬 검증 결과는 [`local_validation_20260703.md`](local_validation_20260703.md)에 정리되어 있습니다. 이 문서는 Go test, `team-validation`, `validate-system --target local`, API 통합 동작 검증, Ops LLM dry-run/evaluator 결과를 제출용 요약과 대표 JSON 산출물로 연결합니다.
