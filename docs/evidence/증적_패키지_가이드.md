...
실제 LLM endpoint 평가 결과는 [`artifacts/local_20260707_ops_llm_evaluation_summary.json`](artifacts/local_20260707_ops_llm_evaluation_summary.json)에 보존합니다. `benchmark_status=executed`, scenario 수, 실행 수, 오류 수와 평균 점수를 확인할 수 있습니다.
